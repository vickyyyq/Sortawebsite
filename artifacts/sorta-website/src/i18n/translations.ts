...
export const translations = {
  ...
  partner: {
    ...
    successBody: { en: 'Thank you for your interest in piloting Sorta. Our team will review your application and reach out shortly.', jp: 'Sortaのパイロットにご関心をいただきありがとうございます。チームが申請内容を確認し、追ってご連絡いたします。' },
    errorTitle: { en: 'Something went wrong', jp: '送信に失敗しました' },
    errorBody: { en: 'We could not submit your application. Please try again or email us directly at', jp: '申請の送信に失敗しました。もう一度お試しいただくか、以下のメールアドレスまで直接ご連絡ください：' },
    errorEmail: { en: 'hello@sorta.co.jp', jp: 'hello@sorta.co.jp' },
    errorRetry: { en: 'Try again', jp: '再試行する' },
