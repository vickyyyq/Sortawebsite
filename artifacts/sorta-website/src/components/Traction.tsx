...
export default function Traction() {
  ...
  const nodes = [
    {
      current: true,
      title: t("Prototype development in progress", "プロトタイプ開発中"),
    },
    {
      current: false,
      title: t("Full-scale demo unit — Late 2026", "フルスケールデモ機 — 2026年後半"),
    },
    {
      current: false,
      title: t("Pilot / PoC deployment", "パイロット／PoC展開"),
    }
  ];
    ...
    <section id="traction" className="bg-[var(--color-fog)] section-padding">
      <div className="max-w-[1200px] mx-auto px-5">
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-8 duration-700 fill-mode-both">
          ...
          <h2>
            {t('Building toward full-scale deployment.', '本格展開へ向けて。')}
          </h2>
        </div>
        ...
        <div className="max-w-3xl mx-auto mt-16 text-center animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500 fill-mode-both">
          <p className="text-[var(--color-text-muted)] italic text-lg bg-white p-6 rounded-xl border border-[var(--color-mist)] shadow-sm">
            {t(
              "We are actively seeking pilot partners to co-develop and test Sorta in real-world environments ahead of commercial launch.",
              "商業ローンチに先立ち、実環境でのSortaの共同開発・テストを行うパイロットパートナーを積極的に募集しています。"
            )}
          </p>
        </div>
      </div>
